...
document.addEventListener('DOMContentLoaded', function () {
    ...
    formAudio.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            if (resp.ok) {
                mensajeAudio.innerHTML = '¡Listo! ✅';
                mensajeAudio.className = 'status-message status-success';
    ...
    formConversion.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            if (resp.ok) {
                mensajeConversion.innerHTML = '¡Listo! ✅';
                mensajeConversion.className = 'status-message status-success';
                ...
                setTimeout(() => {
                    mensajeConversion.classList.add('d-none');
                }, 3000);
